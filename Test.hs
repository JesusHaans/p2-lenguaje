...
t3_Postfix :: Bool
t3_Postfix = Postfix.eval s3 (Postfix.parser $ Postfix.lexer "postfix 6 pop mul swap sel gt") == 1

t4_Postfix :: Bool
t4_Postfix = Postfix.eval s4 (Postfix.parser $ Postfix.lexer "postfix 3 sel 4 add 5 swap sub 6 7 8 3 nget pop pop lt") == 0

t5_Postfix :: Bool
t5_Postfix = Postfix.eval s5 (Postfix.parser $ Postfix.lexer "postfix 0 4 5 gt 6 7 sel 5 8 rem") == 3
